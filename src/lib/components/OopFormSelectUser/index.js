...
import OopSelectUser from '../OopSelectUser';
import styles from './index.less';

export default class OopFormSelectUser extends React.PureComponent {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    const extra = (
      <div>
        ...
        {
          visibleModal ? <OopSelectUser onChange={this.selectUser} users={selected} open={visibleModal} /> : null
        }
      </div>
    )
    return (
